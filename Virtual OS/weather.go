...
func showWeather(w fyne.Window) {
	...
	res, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=new delhi&APPID=c36de749e253d19f97191682c10d9444")
	...
	img := canvas.NewImageFromFile("C:\\Users\\Om sh Ganeshya namah\\Pictures\\weather.jpg")
	...
	label6 := canvas.NewText(fmt.Sprint("Pressure ", weather.Main.Pressure), color.White)
